                ...
                <div class="box-inner">
                    ...
                    <div class="box-content">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="form-group has-feedback">
                                    <label for="pintura_int">¿Necesita vinilo?</label>
...
//                    console.log(qXHR.status,textStatus,errorThrown);
    ...
    {{--$('#formRegistrarGoBlue').on('submit', function (e) {--}}
        {{--e.preventDefault();--}}

        {{--var formData = new FormData(document.getElementById("formRegistrarGoBlue"));--}}
