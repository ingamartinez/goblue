...
<li class="accordion">
	...
	<ul class="nav nav-pills nav-stacked">
		<li><a href="{{url()}}/ejecutivo/create"><i class="glyphicon glyphicon-eye-open"></i> Registrar Go Blue</a></li>
		<li><a href="{{url()}}/ejecutivo"><i class="glyphicon glyphicon-list"></i> Listar Go Blue Registrados</a></li>
		<li><a href="{{url()}}/ejecutivo/show"><i class="glyphicon glyphicon-search"></i> Consultar DMS</a></li>
