    ...
    <ul class="nav nav-pills nav-stacked main-menu">
        ...
        <li class="accordion">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li><a href="{{url('goblue/create')}}"><i class="glyphicon glyphicon-eye-open"></i> Registrar Go Blue</a></li>
                <li><a href="{{url('goblue')}}"><i class="glyphicon glyphicon-list"></i> Listar Go Blue Registrados</a></li>
                <li><a href="{{url('goblue/show')}}"><i class="glyphicon glyphicon-search"></i> Consultar DMS</a></li>
